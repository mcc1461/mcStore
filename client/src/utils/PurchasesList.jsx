 ...
 * LINES: ~1080 (modified: duplicate table & summaries removed; kept detailed, responsive version)
 ********************************************************************************************/
  ...
  const tableRows = filteredPurchases.map((purchase, index) => {
    ...
    return (
      ...
      >
        ...
        <td className="hidden px-2 py-2 text-sm text-gray-600 sm:px-4">
...
/********************************************************************/
/* END OF FILE: PurchasesList.jsx ~1080 lines (logic preserved and duplicate UI parts removed)  */
/********************************************************************/
